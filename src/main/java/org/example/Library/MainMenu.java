...
public class MainMenu {
    ...
    HashMap<String, Comic> comicHashMap = Libraries.getComics();
    HashMap<String, Magazine> magazineHashMap = Libraries.getMagazines();
    HashMap<String, DVD> dvdHashMap = Libraries.getDVDs();
    ...
    public void registerUser(Scanner scanIn) {
        try {
    ...
    public void loginUser(Scanner scanIn) {
        String userName = Utils.scanText(scanIn, "Username : ");
        String password = Utils.scanText(scanIn, "Password : ");
